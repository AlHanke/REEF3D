...
flux_HJ_CDS2::flux_HJ_CDS2(lexer *p)
{
...
void flux_HJ_CDS2::v_flux(fdm* a,int ipol,field&vvel, double &vflux1, double &vflux2)
{
	if(ipol==1)
	{
	pip=2;
...
void flux_HJ_CDS2::w_flux(fdm* a,int ipol,field& wvel, double &wflux1, double &wflux2)
{
