...
#include"flux_HJ_CDS2_vrans.h"
            ...
            o_hj::weno_hj(lexer* p):tttw(13.0/12.0),fourth(1.0/4.0),third(1.0/3.0),
...
v    id weno_hj::iqmin(field& f, double DRM, double *DRDX)
...
v    id weno_hj::jqmin(field& f, double DSM, double *DSDY)
...
v    id weno_hj::kqmin(field& f, double DTM, double *DTDZ)
...
v    id weno_hj::iqmax(field& f, double DRM, double *DRDX)
...
v    id weno_hj::jqmax(field& f, double DSM, double *DSDY)
