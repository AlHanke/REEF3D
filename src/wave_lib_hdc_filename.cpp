...
{
    if(p->A10==3)
    snprintf(name,sizeof(name),"./REEF3D_FNPF_HDC_Input/REEF3D-HDC-Input-%08i-%06i.r3d",num,p->mpirank+1);
    else if(p->A10==6)
...
{
    if(p->A10==3)
    snprintf(name,sizeof(name),"./REEF3D_FNPF_HDC_Input/REEF3D-HDC-Input-%06i.r3d",p->mpirank+1);
    else if(p->A10==6)
...
{
    if(p->A10==3)
    snprintf(name,sizeof(name),"./REEF3D_FNPF_HDC_Input/REEF3D-HDC-Input-Header-%06i.r3d",p->mpirank+1);
    else if(p->A10==6)
