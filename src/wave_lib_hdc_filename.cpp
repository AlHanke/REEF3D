...
{
    if(p->mpirank<9)					sprintf(name,"./REEF3D_CFD_HDC_Input/REEF3D-HDC-Input-0000%i.r3d",p->mpirank+1);
	if(p->mpirank<99&&p->mpirank>8)		sprintf(name,"./REEF3D_CFD_HDC_Input/REEF3D-HDC-Input-000%i.r3d",p->mpirank+1);
	if(p->mpirank<999&&p->mpirank>98)	sprintf(name,"./REEF3D_CFD_HDC_Input/REEF3D-HDC-Input-00%i.r3d",p->mpirank+1);
	if(p->mpirank<9999&&p->mpirank>998)	sprintf(name,"./REEF3D_CFD_HDC_Input/REEF3D-HDC-Input-0%i.r3d",p->mpirank+1);
	if(p->mpirank>9998)					sprintf(name,"./REEF3D_CFD_HDC_Input/REEF3D-HDC-Input-%i.r3d",p->mpirank+1);
