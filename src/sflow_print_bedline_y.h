...
#ifndef SFLOW_PRINT_BEDLINE_Y_H_
#define SFLOW_PRINT_BEDLINE_Y_H_

class sflow_print_bedline_y : public boundarycheck
{
public:
    sflow_print_bedline_y(lexer*,fdm2D*,ghostcell*);
    virtual ~sflow_print_bedline_y();
