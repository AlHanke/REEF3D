...
private:
    ...
    inline void u_flux_impl(fdm*, int ipol, GenericField& uvel, double &uflux1, double &uflux2)
    {
        if(ipol==1)
        {
            if(p->flag1[Im1JK]>0)
    ...
    template<typename GenericField>
    inline void v_flux_impl(fdm*, int ipol, GenericField& vvel, double &vflux1, double &vflux2)
    {
        if(ipol==1)
        {
    ...
    template<typename GenericField>
    inline void w_flux_impl(fdm*, int ipol, GenericField& wvel, double &wflux1, double &wflux2)
    {
        if(ipol==1)
        {
