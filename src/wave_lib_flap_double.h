...
class wave_lib_flap_double : public wave_lib_precalc, public wave_lib_parameters, virtual public increment
{
public:
    wave_lib_flap_double(lexer*);
	virtual ~wave_lib_flap_double() = default;
