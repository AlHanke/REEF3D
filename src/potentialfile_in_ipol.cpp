...
double potentialfile_in::ccipol4(lexer *p, double**F, double xp, double yp, double zp)
{
    int ii,jj,kk;
...
double potentialfile_in::lint4(double **F, int& i,int& j, int& k, double wa, double wb, double wc)
{
    double y1,y2,value;
