...
void sedpart::piecename_pos(lexer* p,fdm* a, ghostcell* pgc, int n)
{
	...
	{
		if(num<10)
		sprintf(pname,"REEF3D-SedPart-00000%i-0000%i.vtu",num,n+1);

		if(num<100&&num>9)
		sprintf(pname,"REEF3D-SedPart-0000%i-0000%i.vtu",num,n+1);

		if(num<1000&&num>99)
		sprintf(pname,"REEF3D-SedPart-000%i-0000%i.vtu",num,n+1);

		if(num<10000&&num>999)
		sprintf(pname,"REEF3D-SedPart-00%i-0000%i.vtu",num,n+1);

		if(num<100000&&num>9999)
		sprintf(pname,"REEF3D-SedPart-0%i-0000%i.vtu",num,n+1);

		if(num>99999)
		sprintf(pname,"REEF3D-SedPart-%i-0000%i.vtu",num,n+1);
	}

	if(n<99&&n>8)
	{
		if(num<10)
		sprintf(pname,"REEF3D-SedPart-00000%i-000%i.vtu",num,n+1);

		if(num<100&&num>9)
		sprintf(pname,"REEF3D-SedPart-0000%i-000%i.vtu",num,n+1);

		if(num<1000&&num>99)
		sprintf(pname,"REEF3D-SedPart-000%i-000%i.vtu",num,n+1);

		if(num<10000&&num>999)
		sprintf(pname,"REEF3D-SedPart-00%i-000%i.vtu",num,n+1);

		if(num<100000&&num>9999)
		sprintf(pname,"REEF3D-SedPart-0%i-000%i.vtu",num,n+1);

		if(num>99999)
		sprintf(pname,"REEF3D-SedPart-%i-000%i.vtu",num,n+1);
	}
	if(n<999&&n>98)
	{
		if(num<10)
		sprintf(pname,"REEF3D-SedPart-00000%i-00%i.vtu",num,n+1);

		if(num<100&&num>9)
		sprintf(pname,"REEF3D-SedPart-0000%i-00%i.vtu",num,n+1);

		if(num<1000&&num>99)
		sprintf(pname,"REEF3D-SedPart-000%i-00%i.vtu",num,n+1);

		if(num<10000&&num>999)
		sprintf(pname,"REEF3D-SedPart-00%i-00%i.vtu",num,n+1);

		if(num<100000&&num>9999)
		sprintf(pname,"REEF3D-SedPart-0%i-00%i.vtu",num,n+1);

		if(num>99999)
		sprintf(pname,"REEF3D-SedPart-%i-00%i.vtu",num,n+1);
	}

	if(n<9999&&n>998)
	{
		if(num<10)
		sprintf(pname,"REEF3D-SedPart-00000%i-0%i.vtu",num,n+1);

		if(num<100&&num>9)
		sprintf(pname,"REEF3D-SedPart-0000%i-0%i.vtu",num,n+1);

		if(num<1000&&num>99)
		sprintf(pname,"REEF3D-SedPart-000%i-0%i.vtu",num,n+1);

		if(num<10000&&num>999)
		sprintf(pname,"REEF3D-SedPart-00%i-0%i.vtu",num,n+1);

		if(num<100000&&num>9999)
		sprintf(pname,"REEF3D-SedPart-0%i-0%i.vtu",num,n+1);

		if(num>99999)
		sprintf(pname,"REEF3D-SedPart-%i-0%i.vtu",num,n+1);
	}

	if(n>9998)
	{
		if(num<10)
		sprintf(pname,"REEF3D-SedPart-00000%i-%i.vtu",num,n+1);

		if(num<100&&num>9)
		sprintf(pname,"REEF3D-SedPart-0000%i-%i.vtu",num,n+1);

		if(num<1000&&num>99)
		sprintf(pname,"REEF3D-SedPart-000%i-%i.vtu",num,n+1);

		if(num<10000&&num>999)
		sprintf(pname,"REEF3D-SedPart-00%i-%i.vtu",num,n+1);

		if(num<100000&&num>9999)
		sprintf(pname,"REEF3D-SedPart-0%i-%i.vtu",num,n+1);

		if(num>99999)
		sprintf(pname,"REEF3D-SedPart-%i-%i.vtu",num,n+1);
	}
