...
void grid::cval_gcpara1(lexer* p, fieldint &cval1)
{
    ...
    p->gcpara6[n][9]=cval1(i,j,k);        
    }
}

void grid::cval_gcpara2(lexer* p, fieldint &cval2)
{
    for(n=0;n<p->gcpara1_count;++n)
    if(p->gcpara1[n][4]==1)
    {
    ...
    p->gcpara6[n][10]=cval2(i,j,k);        
    }
}

void grid::cval_gcpara3(lexer* p, fieldint &cval3)
{
    for(n=0;n<p->gcpara1_count;++n)
    if(p->gcpara1[n][5]==1)
    {
    ...
    p->gcpara6[n][11]=cval3(i,j,k);        
    }
}

void grid::cval_gcpara4(lexer* p, fieldint &cval4)
{
    for(n=0;n<p->gcpara1_count;++n)
    if(p->gcpara1[n][6]==1)
    {
...
void grid::cval_gcpara6(lexer* p, fieldint &cval4)
{
    for(n=0;n<p->gcpara1_count;++n)
    {
    i=p->gcpara1[n][0];
