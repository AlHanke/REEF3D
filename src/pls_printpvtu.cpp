...
void particle_pls::pvtu_pos(fdm* a, lexer* p, ghostcell* pgc)
{
	...
	sprintf(name,"./REEF3D_PLS/XPLS-POS-%0*i.pvtu",p->padding_time,num);
...
void particle_pls::pvtu_neg(fdm* a, lexer* p, ghostcell* pgc)
{
	...
	sprintf(name,"./REEF3D_PLS/XPLS-NEG-%0*i.pvtu",p->padding_time,num);
...
void particle_pls::header_pos(fdm* a,lexer* p,ghostcell* pgc)
{
    ...
    sprintf(name,"./REEF3D_PLS/XPLS-POS-%0*i-%0*i.vtp",p->padding_time,num,p->padding_mpi,p->mpirank+1);
...
void particle_pls::header_neg(fdm* a,lexer* p,ghostcell* pgc)
{
    ...
    sprintf(name,"./REEF3D_PLS/XPLS-NEG-%0*i-%0*i.vtp",p->padding_time,num,p->padding_mpi,p->mpirank+1);
