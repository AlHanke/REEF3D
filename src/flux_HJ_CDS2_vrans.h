...
public:
    ...
    inline void u_flux(fdm* a, int ipol, field& uvel, double &uflux1, double&) final
    { u_flux_impl(a, ipol, uvel, uflux1); }

    inline void v_flux(fdm* a, int ipol, field& vvel, double &vflux1, double&) final
    { v_flux_impl(a, ipol, vvel, vflux1); }

    inline void w_flux(fdm* a, int ipol, field& wvel, double &wflux1, double&) final
    { w_flux_impl(a, ipol, wvel, wflux1); }

    #if USE_AMREX
    inline void u_flux(fdm* a, int ipol, const amrex::Array4<const amrex::Real>& uvel, double &uflux1, double&) final
    { u_flux_impl(a, ipol, uvel, uflux1); }

    inline void v_flux(fdm* a, int ipol, const amrex::Array4<const amrex::Real>& vvel, double &vflux1, double&) final
    { v_flux_impl(a, ipol, vvel, vflux1); }

    inline void w_flux(fdm* a, int ipol, const amrex::Array4<const amrex::Real>& wvel, double &wflux1, double&) final
    { w_flux_impl(a, ipol, wvel, wflux1); }
    #endif
...
private:
    ...
    template<typename GenericField>
    inline void v_flux_impl(fdm* a, int ipol, GenericField& vvel, double &vflux1)
    {
        if(ipol==1)
        {
