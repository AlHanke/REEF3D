...
public:
    ...
    inline void u_flux(fdm* a, int ipol, const field& uvel, double &uflux1, double&) final
    { u_flux_impl(a, ipol, uvel, uflux1); }

    inline void v_flux(fdm* a, int ipol, const field& vvel, double &vflux1, double&) final
    { v_flux_impl(a, ipol, vvel, vflux1); }

    inline void w_flux(fdm* a, int ipol, const field& wvel, double &wflux1, double&) final
    { w_flux_impl(a, ipol, wvel, wflux1); }

    #if USE_AMREX
    inline void u_flux(fdm* a, int ipol, const LocalArr4Const& uvel, double &uflux1, double&) final
    { u_flux_impl(a, ipol, uvel, uflux1); }

    inline void v_flux(fdm* a, int ipol, const LocalArr4Const& vvel, double &vflux1, double&) final
    { v_flux_impl(a, ipol, vvel, vflux1); }

    inline void w_flux(fdm* a, int ipol, const LocalArr4Const& wvel, double &wflux1, double&) final
    { w_flux_impl(a, ipol, wvel, wflux1); }
    #endif
