...
public:
    ...
    inline void v_flux(fdm*, int, const field&, double &vflux1, double &vflux2) final
    ...
    { u_flux_impl(ipol, uvel, uflux1, uflux2); }
    inline void v_flux(fdm*,int, const LocalArr4Const&, double &vflux1, double &vflux2) final
    { vflux1 = 0.0; vflux2 = 0.0; }
