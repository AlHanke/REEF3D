...
#define CPORNH3m  (p->B260==0.0 ? 1.0 : (1.0/(1.0 + (p->B260*(1.0-PORVALNH3m)/(PORVALNH3m*PORVALNH3m)))))
#define CPORNH3  (p->B260==0.0 ? 1.0 : (1.0/(1.0 + (p->B260*(1.0-PORVALNH3)/(PORVALNH3*PORVALNH3)))))
