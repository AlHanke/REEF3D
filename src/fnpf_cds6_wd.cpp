...
fnpf_cds6_wd::fnpf_cds6_wd(lexer* p)
{
}

fnpf_cds6_wd::~fnpf_cds6_wd()
{
}

double fnpf_cds6_wd::fx(lexer *p, field &f, double ivel1, double ivel2)
{
...
double fnpf_cds6_wd::fy(lexer *p, field &f, double jvel1, double jvel2)
{
...
double fnpf_cds6_wd::fz(lexer *p, field &f, double kvel1, double kvel2)
{
