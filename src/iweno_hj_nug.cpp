...
void iweno_hj_nug::wenoloop1(lexer *p, fdm *a, const GenericField& f, int ipol, const GenericField& uvel, const GenericField& vvel, const GenericField& wvel)
{
    DX=p->DXN.data();
    DY=p->DYP.data();
    DZ=p->DZP.data();
...
template<typename GenericField>
void iweno_hj_nug::wenoloop2(lexer *p, fdm *a, const GenericField& f, int ipol, const GenericField& uvel, const GenericField& vvel, const GenericField& wvel)
{
    DX=p->DXP.data();
    DY=p->DYN.data();
    DZ=p->DZP.data();
...
template<typename GenericField>
void iweno_hj_nug::wenoloop3(lexer *p, fdm *a, const GenericField& f, int ipol, const GenericField& uvel, const GenericField& vvel, const GenericField& wvel)
{
    DX=p->DXP.data();
    DY=p->DYP.data();
    DZ=p->DZN.data();
...
template<typename GenericField>
void iweno_hj_nug::wenoloop4(lexer *p, fdm *a, const GenericField& f, int ipol, const GenericField& uvel, const GenericField& vvel, const GenericField& wvel)
{
    DX=p->DXP.data();
    DY=p->DYP.data();
    DZ=p->DZP.data();
...
void iweno_hj_nug::aij_south(lexer* p, fdm* a, const CF &f, MF &F)
{
...
template<typename CF, typename MF>
void iweno_hj_nug::aij_north(lexer* p, fdm* a, const CF &f, MF &F)
{
...
template<typename CF, typename MF>
void iweno_hj_nug::aij_east(lexer* p, fdm* a, const CF &f, MF &F)
{
...
template<typename CF, typename MF>
void iweno_hj_nug::aij_west(lexer* p, fdm* a, const CF &f, MF &F)
{
...
template<typename CF, typename MF>
void iweno_hj_nug::aij_bottom(lexer* p, fdm* a, const CF &f, MF &F)
{
...
template<typename CF, typename MF>
void iweno_hj_nug::aij_top(lexer* p, fdm* a, const CF &f, MF &F)
{
...
template<typename GenericField>
void iweno_hj_nug::iqmin(lexer *p,fdm *a, const GenericField& f)
{
...
template<typename GenericField>
void iweno_hj_nug::jqmin(lexer *p,fdm *a, const GenericField& f)
{
...
template<typename GenericField>
void iweno_hj_nug::kqmin(lexer *p,fdm *a, const GenericField& f)
{
...
template<typename GenericField>
void iweno_hj_nug::iqmax(lexer *p,fdm *a, const GenericField& f)
{
...
template<typename GenericField>
void iweno_hj_nug::jqmax(lexer *p,fdm *a, const GenericField& f)
{
...
template<typename GenericField>
void iweno_hj_nug::kqmax(lexer *p,fdm *a, const GenericField& f)
{
