...
{	
	...
	sprintf(name,"./REEF3D_SFLOW_VTP_FSF/REEF3D-SFLOW-FSF-%0*i.pvtp",p->padding_time,num);
...
void sflow_vtp_fsf::piecename(lexer *p, fdm2D *b, ghostcell *pgc, int n)
{
	...
	sprintf(pname,"REEF3D-SFLOW-FSF-%0*i-%0*i.vtp",p->padding_time,num,p->padding_mpi,n+1);
}
