...
void vts3D::pvtr(fdm* a, lexer* p, ghostcell* pgc, turbulence *pturb, heat *pheat, data *pdata, concentration *pconc, multiphase *pmp, sediment *psed)
{
    int num=0;
	...
	result<<"<PPoints>"<<endl;
	result<<"<PDataArray type=\"Float32\" NumberOfComponents=\"3\" format=\"ascii\"/>"<<endl;
	// result<<"<PDataArray type=\"Float32\" NumberOfComponents=\"3\" format=\"appended\"/>"<<endl;
    result<<"</PPoints>"<<endl;
