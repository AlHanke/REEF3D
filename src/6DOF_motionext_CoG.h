...
#ifndef SIXDOF_MOTIONEXT_FILE_COG_H_
#define SIXDOF_MOTIONEXT_FILE_COG_H_
...
class sixdof_motionext_file_CoG : public sixdof_motionext
{
public:
    ...
    sixdof_motionext_file_CoG(lexer*);
	virtual ~sixdof_motionext_file_CoG() = default;
