...
void control::read_control(lexer* p)
{
    ...
    else
    {
        ...
        case 'A': control>>numint;
               ...
               case 370: control>>A370;
                        clear(c,numint);
                        break;
               case 371: control>>A371_u>>A371_dir;
                        clear(c,numint);
                        break;
               case 372: control>>A372_xs>>A372_xe>>A372_ys>>A372_ye;
                        A372=1;
                        clear(c,numint);
                        break;
               case 373: control>>A373;
                        clear(c,numint);
                        break;
        ...
        case 'B': control>>numint;
            ...
            case 'F': control>>numint;
                ...
                case 98: control>>F98;
                        clear(c,numint);
                        break;
                case 100: control>>F100;
                        clear(c,numint);
                        break;
                case 101: control>>F101_nx>>F101_ny>>F101_nz>>F101_s>>F101_e;
                          clear(c,numint);
                          break;
                case 112: ++F112;
                        clear(c,numint);
        ...
        case 'X': control>>numint;
               ...
               case  50: control>>X50;
                ...
                case  170: control>>X170_xs>>X170_xe>>X170_ys>>X170_ye>>X170_zs>>X170_ze;
                        ...
                        clear(c,numint);
                        break;
                case  171: control>>X171_xs>>X171_xe>>X171_ys>>X171_ye>>X171_zs>>X171_z1>>X171_ze;
                        X171=1;
                        clear(c,numint);
                        break;
                case  172: control>>X172_xs>>X172_xe>>X172_ys>>X172_ye>>X172_zs>>X172_z1>>X172_z2>>X172_ze;
                        X172=1;
                        clear(c,numint);
                        break;
    ...
    // A
    resize.Darray(A581_xs,A581);
    resize.Darray(A581_xe,A581);
    resize.Darray(A581_ys,A581);
    resize.Darray(A581_ye,A581);
    resize.Darray(A581_zs,A581);
    resize.Darray(A581_ze,A581);

    resize.Darray(A583_xc,A583);
    resize.Darray(A583_zc,A583);
    resize.Darray(A583_ys,A583);
    resize.Darray(A583_ye,A583);
    resize.Darray(A583_r,A583);

    resize.Darray(A584_xc,A584);
    resize.Darray(A584_yc,A584);
    resize.Darray(A584_zs,A584);
    resize.Darray(A584_ze,A584);
    resize.Darray(A584_r,A584);

    resize.Darray(A585_xm1,A585);
    resize.Darray(A585_ym1,A585);
    resize.Darray(A585_zm1,A585);
    resize.Darray(A585_r1,A585);
    resize.Darray(A585_xm2,A585);
    resize.Darray(A585_ym2,A585);
    resize.Darray(A585_zm2,A585);
    resize.Darray(A585_r2,A585);

    resize.Darray(A586_xm,A586);
    resize.Darray(A586_ym,A586);
    resize.Darray(A586_zm,A586);
    resize.Darray(A586_r,A586);

    resize.Darray(A587_xs,A587);
    resize.Darray(A587_xe,A587);
    resize.Darray(A587_ys,A587);
    resize.Darray(A587_ye,A587);
    resize.Darray(A587_zs,A587);
    resize.Darray(A587_ze,A587);

    resize.Darray(A588_xs,A588);
    resize.Darray(A588_xe,A588);
    resize.Darray(A588_ys,A588);
    resize.Darray(A588_ye,A588);
    resize.Darray(A588_zs,A588);
    resize.Darray(A588_ze,A588);

    resize.Darray(A589_xs,A589);
    resize.Darray(A589_xe,A589);
    resize.Darray(A589_ys,A589);
    resize.Darray(A589_ye,A589);
    resize.Darray(A589_zs,A589);
    resize.Darray(A589_ze,A589);

    // B
    resize.Darray(B71_val,B71);
    resize.Darray(B71_dist,B71);
    resize.Darray(B71_b,B71);
    resize.Darray(B71_x,B71);
    resize.Darray(B71_y,B71);

    resize.Darray(B106_b,B106);
    resize.Darray(B106_x,B106);
    resize.Darray(B106_y,B106);

    resize.Darray(B107_xs,B107);
    resize.Darray(B107_xe,B107);
    resize.Darray(B107_ys,B107);
    resize.Darray(B107_ye,B107);
    resize.Darray(B107_d,B107);

    resize.Darray(B108_xs,B108);
    resize.Darray(B108_xe,B108);
    resize.Darray(B108_ys,B108);
    resize.Darray(B108_ye,B108);
    resize.Darray(B108_d,B108);


    resize.Darray(B240_C,B240);
    resize.Darray(B240_D,B240);
    resize.Darray(B240_xs,B240);
    resize.Darray(B240_xe,B240);
    resize.Darray(B240_ys,B240);
    resize.Darray(B240_ye,B240);
    resize.Darray(B240_zs,B240);
    resize.Darray(B240_ze,B240);

    resize.Darray(B270_xs,B270);
    resize.Darray(B270_xe,B270);
    resize.Darray(B270_ys,B270);
    resize.Darray(B270_ye,B270);
    resize.Darray(B270_zs,B270);
    resize.Darray(B270_ze,B270);
    resize.Darray(B270_n,B270);
    resize.Darray(B270_d50,B270);
    resize.Darray(B270_alpha,B270);
    resize.Darray(B270_beta,B270);

    resize.Darray(B274_xc,B274);
    resize.Darray(B274_yc,B274);
    resize.Darray(B274_zs,B274);
    resize.Darray(B274_ze,B274);
    resize.Darray(B274_r,B274);
    resize.Darray(B274_n,B274);
    resize.Darray(B274_d50,B274);
    resize.Darray(B274_alpha,B274);
    resize.Darray(B274_beta,B274);

    resize.Darray(B281_xs,B281);
    resize.Darray(B281_xe,B281);
    resize.Darray(B281_ys,B281);
    resize.Darray(B281_ye,B281);
    resize.Darray(B281_zs,B281);
    resize.Darray(B281_ze,B281);
    resize.Darray(B281_n,B281);
    resize.Darray(B281_d50,B281);
    resize.Darray(B281_alpha,B281);
    resize.Darray(B281_beta,B281);

    resize.Darray(B282_xs,B282);
    resize.Darray(B282_xe,B282);
    resize.Darray(B282_ys,B282);
    resize.Darray(B282_ye,B282);
    resize.Darray(B282_zs,B282);
    resize.Darray(B282_ze,B282);
    resize.Darray(B282_n,B282);
    resize.Darray(B282_d50,B282);
    resize.Darray(B282_alpha,B282);
    resize.Darray(B282_beta,B282);

    resize.Darray(B291_xs,B291);
    resize.Darray(B291_xe,B291);
    resize.Darray(B291_ys,B291);
    resize.Darray(B291_ye,B291);
    resize.Darray(B291_zs,B291);
    resize.Darray(B291_ze,B291);
    resize.Darray(B291_d,B291);
    resize.Darray(B291_n,B291);
    resize.Darray(B291_d50,B291);
    resize.Darray(B291_alpha,B291);
    resize.Darray(B291_beta,B291);

    resize.Darray(B310_xs,B310);
    resize.Darray(B310_xe,B310);
    resize.Darray(B310_ys,B310);
    resize.Darray(B310_ye,B310);
    resize.Darray(B310_zs,B310);
    resize.Darray(B310_ze,B310);
    resize.Darray(B310_N,B310);
    resize.Darray(B310_D,B310);
    resize.Darray(B310_Cd,B310);

    resize.Darray(B321_xs,B321);
    resize.Darray(B321_xe,B321);
    resize.Darray(B321_ys,B321);
    resize.Darray(B321_ye,B321);
    resize.Darray(B321_zs,B321);
    resize.Darray(B321_ze,B321);
    resize.Darray(B321_N,B321);
    resize.Darray(B321_D,B321);
    resize.Darray(B321_Cd,B321);

    resize.Darray(B322_xs,B322);
    resize.Darray(B322_xe,B322);
    resize.Darray(B322_ys,B322);
    resize.Darray(B322_ye,B322);
    resize.Darray(B322_zs,B322);
    resize.Darray(B322_ze,B322);
    resize.Darray(B322_N,B322);
    resize.Darray(B322_D,B322);
    resize.Darray(B322_Cd,B322);

    resize.Iarray(B411_ID,B411);
    resize.Darray(B411_Q,B411);

    resize.Iarray(B412_ID,B412);
    resize.Darray(B412_pressBC,B412);

    resize.Iarray(B413_ID,B413);
    resize.Darray(B413_h,B413);

    resize.Iarray(B414_ID,B414);
    resize.Darray(B414_Uio,B414);

    resize.Iarray(B415_ID,B415);
    resize.Darray(B415_U,B415);
    resize.Darray(B415_V,B415);
    resize.Darray(B415_W,B415);
    resize.Iarray(B416_ID,B416);
    resize.Darray(B416_alpha,B416);
    resize.Iarray(B417_ID,B417);
    resize.Darray(B417_Nx,B417);
    resize.Darray(B417_Ny,B417);
    resize.Darray(B417_Nz,B417);
    resize.Iarray(B418_ID,B418);
    resize.Iarray(B418_pio,B418);
    resize.Iarray(B421_ID,B421);
    resize.Iarray(B421_Q,B421);
    resize.Iarray(B422_ID,B422);
    resize.Iarray(B422_FSF,B422);

    resize.Iarray(B440_ID,B440);
    resize.Iarray(B440_face,B440);
    resize.Darray(B440_xs,B440);
    resize.Darray(B440_xe,B440);
    resize.Darray(B440_ys,B440);
    resize.Darray(B440_ye,B440);

    resize.Iarray(B441_ID,B441);
    resize.Iarray(B441_face,B441);
    resize.Darray(B441_xs,B441);
    resize.Darray(B441_xe,B441);
    resize.Darray(B441_ys,B441);
    resize.Darray(B441_ye,B441);
    resize.Darray(B441_zs,B441);
    resize.Darray(B441_ze,B441);

    resize.Iarray(B442_ID,B442);
    resize.Iarray(B442_face,B442);
    resize.Darray(B442_xm,B442);
    resize.Darray(B442_ym,B442);
    resize.Darray(B442_zm,B442);
    resize.Darray(B442_r,B442);

    // C
    resize.Darray(C75_x,C75);
    resize.Darray(C75_z,C75);
    resize.Darray(C75_a,C75);
    resize.Darray(C75_s,C75);
    resize.Darray(C75_l,C75);
    resize.Darray(C75_v,C75);

    // F
    resize.Darray(F70_xs,F70);
    resize.Darray(F70_xe,F70);

    resize.Darray(F70_ys,F70);
    resize.Darray(F70_ye,F70);

    resize.Darray(F70_zs,F70);
    resize.Darray(F70_ze,F70);

    resize.Darray(F71_xs,F71);
    resize.Darray(F71_xe,F71);

    resize.Darray(F71_ys,F71);
    resize.Darray(F71_ye,F71);

    resize.Darray(F71_zs,F71);
    resize.Darray(F71_ze,F71);

    resize.Darray(F72_xs,F72);
    resize.Darray(F72_xe,F72);

    resize.Darray(F72_ys,F72);
    resize.Darray(F72_ye,F72);

    resize.Darray(F72_h,F72);

    resize.Darray(F112_xs,F112);
    resize.Darray(F112_xe,F112);

    resize.Darray(F112_ys,F112);
    resize.Darray(F112_ye,F112);

    resize.Darray(F112_zs,F112);
    resize.Darray(F112_ze,F112);

    resize.Darray(F113_xs,F113);
    resize.Darray(F113_xe,F113);

    resize.Darray(F113_ys,F113);
    resize.Darray(F113_ye,F113);

    resize.Darray(F113_zs,F113);
    resize.Darray(F113_ze,F113);

    resize.Darray(F114_xs,F114);
    resize.Darray(F114_xe,F114);

    resize.Darray(F114_ys,F114);
    resize.Darray(F114_ye,F114);

    resize.Darray(F114_zs,F114);
    resize.Darray(F114_ze,F114);

    resize.Darray(F115_xs,F115);
    resize.Darray(F115_xe,F115);

    resize.Darray(F115_ys,F115);
    resize.Darray(F115_ye,F115);

    resize.Darray(F115_zs,F115);
    resize.Darray(F115_ze,F115);

    if(F369>0)
    {
        resize.Darray(F369_x,F369);
        resize.Darray(F369_z,F369);

        resize.Darray(F369_a,F369);
        resize.Darray(F369_s,F369);
        resize.Darray(F369_l,F369);
        resize.Darray(F369_v,F369);
    }

    if(F370>0)
    {
        resize.Darray(F370_xs,F370);
        resize.Darray(F370_xe,F370);

        resize.Darray(F370_ys,F370);
        resize.Darray(F370_ye,F370);

        resize.Darray(F370_zs,F370);
        resize.Darray(F370_ze,F370);
    }

    if(F371>0)
    {
        resize.Darray(F371_xs,F371);
        resize.Darray(F371_xe,F371);

        resize.Darray(F371_ys,F371);
        resize.Darray(F371_ye,F371);

        resize.Darray(F371_zs,F371);
        resize.Darray(F371_ze,F371);
    }

    if(F374>0)
    {
        resize.Darray(F374_xc,F374);
        resize.Darray(F374_zc,F374);
        resize.Darray(F374_r,F374);
    }

    if(F375>0)
    {
        resize.Darray(F375_xc,F375);
        resize.Darray(F375_zc,F375);
        resize.Darray(F375_r,F375);
    }

    if(F378>0)
    {
        resize.Darray(F378_xc,F378);
        resize.Darray(F378_yc,F378);
        resize.Darray(F378_zc,F378);
        resize.Darray(F378_r,F378);
    }

    if(F379>0)
    {
        resize.Darray(F379_xc,F379);
        resize.Darray(F379_yc,F379);
        resize.Darray(F379_zc,F379);
        resize.Darray(F379_r,F379);
    }

    if(F390>0)
    {
        resize.Darray(F390_xs,F390);
        resize.Darray(F390_xe,F390);

        resize.Darray(F390_ys,F390);
        resize.Darray(F390_ye,F390);

        resize.Darray(F390_zs,F390);
        resize.Darray(F390_ze,F390);
    }

    if(F391>0)
    {
        resize.Darray(F391_xs,F391);
        resize.Darray(F391_xe,F391);

        resize.Darray(F391_ys,F391);
        resize.Darray(F391_ye,F391);

        resize.Darray(F391_zs,F391);
        resize.Darray(F391_ze,F391);
    }

    if(F394>0)
    {
        resize.Darray(F394_xc,F394);
        resize.Darray(F394_zc,F394);
        resize.Darray(F394_r,F394);
    }

    if(F395>0)
    {
        resize.Darray(F395_xc,F395);
        resize.Darray(F395_zc,F395);
        resize.Darray(F395_r,F395);
    }

    if(F398>0)
    {
        resize.Darray(F398_xc,F398);
        resize.Darray(F398_yc,F398);
        resize.Darray(F398_zc,F398);
        resize.Darray(F398_r,F398);
    }

    if(F399>0)
    {
        resize.Darray(F399_xc,F399);
        resize.Darray(F399_yc,F399);
        resize.Darray(F399_zc,F399);
        resize.Darray(F399_r,F399);
    }

    // P
    resize.Darray(P35_ts,P35);
    resize.Darray(P35_te,P35);
    resize.Darray(P35_dt,P35);

    resize.Darray(P50_x,P50);
    resize.Darray(P50_y,P50);

    resize.Darray(P51_x,P51);
    resize.Darray(P51_y,P51);

    resize.Darray(P52_y,P52);
    resize.Darray(P56_x,P56);

    resize.Darray(P58_x,P58);
    resize.Darray(P58_y,P58);
    resize.Darray(P58_T,P58);

    resize.Darray(P61_x,P61);
    resize.Darray(P61_y,P61);
    resize.Darray(P61_z,P61);

    resize.Darray(P62_xs,P62);
    resize.Darray(P62_ys,P62);
    resize.Darray(P62_zs,P62);
    resize.Darray(P62_xe,P62);
    resize.Darray(P62_ye,P62);
    resize.Darray(P62_ze,P62);

    resize.Darray(P63_x,P63);
    resize.Darray(P63_y,P63);

    resize.Darray(P64_x,P64);
    resize.Darray(P64_y,P64);
    resize.Darray(P64_z,P64);

    resize.Darray(P65_x,P65);
    resize.Darray(P65_y,P65);
    resize.Darray(P65_z,P65);

    resize.Darray(P66_x,P66);
    resize.Darray(P66_y,P66);
    resize.Darray(P66_z,P66);

    resize.Darray(P67_x,P67);
    resize.Darray(P67_y,P67);

    resize.Darray(P68_x,P68);
    resize.Darray(P68_y,P68);

    resize.Darray(P69_x,P69);
    resize.Darray(P69_y,P69);

    resize.Darray(P167_x,P167);

    resize.Darray(P168_x,P168);
    resize.Darray(P168_zs,P168);
    resize.Darray(P168_ze,P168);

    resize.Darray(P81_xs,P81);
    resize.Darray(P81_ys,P81);
    resize.Darray(P81_zs,P81);
    resize.Darray(P81_xe,P81);
    resize.Darray(P81_ye,P81);
    resize.Darray(P81_ze,P81);

    resize.Darray(P85_x,P85);
    resize.Darray(P85_y,P85);
    resize.Darray(P85_r,P85);
    resize.Darray(P85_cd,P85);
    resize.Darray(P85_cm,P85);

    resize.Darray(P88_x,P88);
    resize.Darray(P88_y,P88);

    resize.Darray(P121_x,P121);
    resize.Darray(P121_y,P121);

    resize.Darray(P123_y,P123);

    resize.Darray(P124_x,P124);

    resize.Darray(P125_x,P125);
    resize.Darray(P125_y,P125);

    resize.Darray(P133_y,P133);
    resize.Darray(P134_y,P134);

    resize.Darray(P140_x,P140);
    resize.Darray(P140_y,P140);

    resize.Iarray(P184_its,P184);
    resize.Iarray(P184_ite,P184);
    resize.Iarray(P184_dit,P184);

    resize.Darray(P185_ts,P185);
    resize.Darray(P185_te,P185);
    resize.Darray(P185_dt,P185);

    resize.Iarray(P194_its,P194);
    resize.Iarray(P194_ite,P194);
    resize.Iarray(P194_dit,P194);

    resize.Darray(P195_ts,P195);
    resize.Darray(P195_te,P195);
    resize.Darray(P195_dt,P195);

    resize.Darray(P230_x,P230);
    resize.Darray(P240_x,P240);

    resize.Darray(P351_x,P351);
    resize.Darray(P351_y,P351);
    resize.Darray(P352_x,P352);
    resize.Darray(P352_y,P352);

    // Q
    resize.Darray(Q61_x,Q61);
    resize.Darray(Q61_y,Q61);
    resize.Darray(Q61_z,Q61);
    resize.Iarray(Q61_i,Q61);
    resize.Darray(Q73_val,Q73);
    resize.Darray(Q73_dist,Q73);
    resize.Darray(Q73_b,Q73);
    resize.Darray(Q73_x,Q73);
    resize.Darray(Q73_y,Q73);
    resize.Darray(Q110_xs,Q110);
    resize.Darray(Q110_ys,Q110);
    resize.Darray(Q110_zs,Q110);
    resize.Darray(Q110_xe,Q110);
    resize.Darray(Q110_ye,Q110);
    resize.Darray(Q110_ze,Q110);
    resize.Darray(Q111_xs,Q111);
    resize.Darray(Q111_ys,Q111);
    resize.Darray(Q111_zs,Q111);
    resize.Darray(Q111_xe,Q111);
    resize.Darray(Q111_ye,Q111);
    resize.Darray(Q111_ze,Q111);

    // S
    resize.Darray(S73_val,S73);
    resize.Darray(S73_dist,S73);
    resize.Darray(S73_b,S73);
    resize.Darray(S73_x,S73);
    resize.Darray(S73_y,S73);

    resize.Darray(S74_xs,S74);
    resize.Darray(S74_xe,S74);
    resize.Darray(S74_ys,S74);
    resize.Darray(S74_ye,S74);

    // W
    resize.Darray(W41_xc,W41);
    resize.Darray(W41_yc,W41);
    resize.Darray(W41_zs,W41);
    resize.Darray(W41_ze,W41);
    resize.Darray(W41_vel,W41);
    resize.Darray(W41_beta,W41);

    // X
    resize.Darray(X102_u,X102);
    resize.Darray(X102_v,X102);
    resize.Darray(X102_w,X102);

    resize.Darray(X110_xs,X110);
    resize.Darray(X110_ys,X110);
    resize.Darray(X110_zs,X110);
    resize.Darray(X110_xe,X110);
    resize.Darray(X110_ye,X110);
    resize.Darray(X110_ze,X110);

    resize.Darray(X163_x1,X163);
    resize.Darray(X163_y1,X163);
    resize.Darray(X163_z1,X163);
    resize.Darray(X163_x2,X163);
    resize.Darray(X163_y2,X163);
    resize.Darray(X163_z2,X163);
    resize.Darray(X163_x3,X163);
    resize.Darray(X163_y3,X163);
    resize.Darray(X163_z3,X163);
    resize.Darray(X163_x4,X163);
    resize.Darray(X163_y4,X163);
    resize.Darray(X163_z4,X163);
    resize.Darray(X163_x5,X163);
    resize.Darray(X163_y5,X163);
    resize.Darray(X163_z5,X163);
    resize.Darray(X163_x6,X163);
    resize.Darray(X163_y6,X163);
    resize.Darray(X163_z6,X163);

    resize.Darray(X164_x1,X164);
    resize.Darray(X164_y1,X164);
    resize.Darray(X164_z1,X164);
    resize.Darray(X164_x2,X164);
    resize.Darray(X164_y2,X164);
    resize.Darray(X164_z2,X164);
    resize.Darray(X164_x3,X164);
    resize.Darray(X164_y3,X164);
    resize.Darray(X164_z3,X164);
    resize.Darray(X164_x4,X164);
    resize.Darray(X164_y4,X164);
    resize.Darray(X164_z4,X164);
    resize.Darray(X164_x5,X164);
    resize.Darray(X164_y5,X164);
    resize.Darray(X164_z5,X164);
    resize.Darray(X164_x6,X164);
    resize.Darray(X164_y6,X164);
    resize.Darray(X164_z6,X164);
    resize.Darray(X164_x7,X164);
    resize.Darray(X164_y7,X164);
    resize.Darray(X164_z7,X164);
    resize.Darray(X164_x8,X164);
    resize.Darray(X164_y8,X164);
    resize.Darray(X164_z8,X164);

    if (X311 > 0)
    {
        resize.Darray(X311_xs,X311);
        resize.Darray(X311_ys,X311);
        resize.Darray(X311_zs,X311);
        resize.Darray(X311_xe,X311);
        resize.Darray(X311_ye,X311);
        resize.Darray(X311_ze,X311);
        resize.Darray(X311_w,X311);
        resize.Darray(X311_rho_c,X311);
        resize.Darray(X311_EA,X311);
        resize.Darray(X311_d,X311);
        resize.Darray(X311_l,X311);
        resize.Darray(X311_H,X311);
        resize.Darray(X311_P,X311);
        resize.Darray(X311_facT,X311);

        p->mooring_count = X311;

        resize.Darray(X314_T,X311);
        resize.Darray(X315_t,X311);
    }
    else
    {
        resize.Darray(X311_xs,X312);
        resize.Darray(X311_ys,X312);
        resize.Darray(X311_zs,X312);
        resize.Darray(X311_xe,X312);
        resize.Darray(X311_ye,X312);
        resize.Darray(X311_ze,X312);
        resize.Darray(X312_k,X312);
        resize.Darray(X312_T0,X312);
        ...
        resize.Darray(X314_T,X312);
        resize.Darray(X315_t,X312);
    }

    if (X321 > 0)
    {
        resize.Iarray(X320_type,X320);

        resize.Darray(X321_Sn,X321);
        resize.Darray(X321_d,X321);
        resize.Darray(X321_lambda,X321);
        resize.Darray(X321_dk,X321);
        resize.Darray(X321_rho,X321);
        resize.Darray(X321_nd,X321);
        resize.Darray(X321_nl,X321);

        resize.Darray(X322_D,X321);
        resize.Darray(X322_L,X321);
        resize.Darray(X322_x0,X321);
        resize.Darray(X322_y0,X321);
        resize.Darray(X322_z0,X321);
        resize.Darray(X322_phi,X321);
        resize.Darray(X322_theta,X321);
        resize.Darray(X322_psi,X321);

        p->net_count = X321;
    }

    resize.Darray(X324_x,X324);
    resize.Darray(X324_y,X324);
    resize.Darray(X324_z,X324);

    if (Z11 > 0)
    {
        resize.Darray(Z11_x,Z11);
        resize.Darray(Z11_y,Z11);
        resize.Darray(Z11_z,Z11);
        resize.Darray(Z11_l,Z11);
        resize.Darray(Z11_w,Z11);
        resize.Darray(Z11_t,Z11);
        resize.Darray(Z11_rho,Z11);
        resize.Darray(Z11_e,Z11);
        resize.Darray(Z11_ix,Z11);
        resize.Darray(Z11_iy,Z11);
        resize.Darray(Z11_iz,Z11);
        resize.Darray(Z11_nu,Z11);
        resize.Darray(Z11_n,Z11);
        ...
        else
        {
            ...
            case 'P': control>>numint;
               ...
               case 63: control>>P63_x[countP63]>>P63_y[countP63];
                ...
                case 85: control>>P85_x[countP85]>>P85_y[countP85]>>P85_r[countP85]>>P85_cd[countP85]>>P85_cm[countP85];
                        ...
                        clear(c,numint);
                        break;
                 case 88: control>>P88_x[countP88]>>P88_y[countP88];
                        ++countP88;
                        clear(c,numint);
                        break;
               ...
               case 134: control>>P134_y[countP134];
                        ...
                        clear(c,numint);
                        break;
               case 140: control>>P140_x[countP140]>>P140_y[countP140];
                        ++countP140;
                        clear(c,numint);
                        break;
            ...
            case 'S': control>>numint;
                ...
                case 73: control>>S73_val[countS73]>>S73_dist[countS73]>>S73_b[countS73]>>S73_x[countS73]>>S73_y[countS73];
                        ...
                        clear(c,numint);
                        break;
                 case 74: control>>S74_xs[countS74]>>S74_xe[countS74]>>S74_ys[countS74]>>S74_ye[countS74];
                        ++countS74;
                        clear(c,numint);
                        break;
                }
