...
void concentration_void::print_3D(lexer *p, fdm *a, ghostcell *pgc, std::vector<char>& buffer, int &m)
{
}
...
void concentration_void::name_ParaView(lexer *p, fdm *a, ghostcell *pgc, stringstream &result, int *offset, int &n)
{
}
