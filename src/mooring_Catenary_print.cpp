...
void mooring_Catenary::print(lexer *p)
{
    ...
    )
    {
        ...
        if(p->A10==5)
        sprintf(name,"./REEF3D_NHFLOW_6DOF_Mooring/REEF3D-Mooring-%0*i-%0*i.vtk",p->padding_time,line,p->padding_mpi,num);

        if(p->A10==6)
        sprintf(name,"./REEF3D_CFD_6DOF_Mooring/REEF3D-Mooring-%0*i-%0*i.vtk",p->padding_time,line,p->padding_mpi,num);
