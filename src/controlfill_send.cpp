...
void control::ctrlsend()
{
    ...
    dctrl[dd] = W104;
    dd++;
    dctrl[dd] = W105_tau_00;
    dd++;
    dctrl[dd] = W105_C_total;
    dd++;
    dctrl[dd] = W105_C_kaolinite_chlorite;
    dd++;
    dctrl[dd] = W105_C_illite;
    dd++;
    dctrl[dd] = W105_C_montmorillonite;
    dd++;
    dctrl[dd] = W106_b;
    dd++;
    dctrl[dd] = W106_m_y;
    dd++;
    dctrl[dd] = W107_mu_min;
    dd++;
    dctrl[dd] = W107_delta;
    dd++;
    dctrl[dd] = W107_mu_0;
...
// --------------------------
    ...
    for(n=0;n<P145;++n)
    {
        ...
        ictrl[ii] = P145_n[n];
        ii++;
        dctrl[dd] = P145_tbegin[n];
        dd++;
        dctrl[dd] = P145_tend[n];
        dd++;
    }
    ...
    for(n=0;n<P146;++n)
    {
        dctrl[dd] = P146_y[n];
        dd++;
        dctrl[dd] = P146_tbegin[n];
        dd++;
        dctrl[dd] = P146_tend[n];
        dd++;
    }
    ...
    for(n=0;n<P147;++n)
    {
        dctrl[dd] = P147_x[n];
        dd++;
        dctrl[dd] = P147_tbegin[n];
        dd++;
        dctrl[dd] = P147_tend[n];
        dd++;
    }
    ...
    for(n=0;n<P148;++n)
    {
        ...
        dctrl[dd] = P148_y[n];
        dd++;
        dctrl[dd] = P148_tbegin[n];
        dd++;
        dctrl[dd] = P148_tend[n];
        dd++;
    }
