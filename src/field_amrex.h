...
public:
     ...
     */
    inline double& operator()(int ii, int jj, int kk) noexcept final
    {
     ...
     */
    inline const double& operator()(int ii, int jj, int kk) const noexcept final
    {
     ...
     */
    inline double& operator()(const amrex::IntVect& iv, int comp = 0) noexcept final
    {
        refresh_cache_if_needed();
     ...
     */
    inline const double& operator()(const amrex::IntVect& iv, int comp = 0) const noexcept final
    {
        refresh_const_cache_if_needed();
