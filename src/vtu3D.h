...
class vtu3D final : public vtk3D , increment
{
    public:
        ...
        void structureWrite(lexer*, fdm_fnpf*, std::vector<char>&, size_t&) override final;
        void structureWrite(lexer*, fdm_nhf*, std::vector<char>&, size_t&) override final;
    private:
