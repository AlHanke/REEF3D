...
void probe_line::start(lexer *p, fdm *a, ghostcell *pgc, turbulence *pturb)
{
	...
	for(n=0;n<p->P62;++n)
	{
		...
		{
			// open file
			sprintf(name,"./REEF3D_CFD_ProbeLine/REEF3D-CFD-probeline-%i-%0*i.dat",n+1,p->padding_time,num);
