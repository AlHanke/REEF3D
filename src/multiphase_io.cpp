...
void multiphase_f::print_3D(lexer *p, fdm *a, ghostcell *pgc, std::vector<char> &buffer, int &m)
{
    iin=4*(p->pointnum);
...
void multiphase_f::name_ParaView(lexer *p, fdm *a, ghostcell *pgc, stringstream &result, int *offset, int &n)
{
