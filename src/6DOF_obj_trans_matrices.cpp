...
void sixdof_obj::get_trans(lexer *p, Eigen::Vector3d& dp_, Eigen::Vector3d& dc_, Eigen::Vector3d& pp_, Eigen::Vector3d& )
{
    dp_ = Ffb_; 
    dc_ = pp_/Mass_fb;

	// External motions
	pmotion->motionext_trans(p,dp_,dc_);
} 

void sixdof_obj::get_rot(lexer *p, Eigen::Vector3d& , Eigen::Vector4d& de_, Eigen::Vector3d& h_, Eigen::Vector4d& )
{
