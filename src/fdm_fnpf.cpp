...
fdm_fnpf::fdm_fnpf(lexer *p) : press(p),test(p),nodeval(p),eta(p),eta_n(p),WL(p),bed(p),depth(p),
                              Fifsf(p),Fibed(p),Fz(p),K(p),
                              etaloc(p),wet_n(p),breaking(p),breaklog(p),bc(p),
                              Fx(p),Fy(p),Ex(p),Ey(p),
                              Exx(p),Eyy(p),Bx(p),By(p),
                              Bxx(p),Byy(p),Hx(p),Hy(p),
