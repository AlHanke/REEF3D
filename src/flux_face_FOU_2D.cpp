...
flux_face_FOU_2D::flux_face_FOU_2D(lexer *pp)
{
    p=pp;

}

flux_face_FOU_2D::~flux_face_FOU_2D()
{
}

void flux_face_FOU_2D::u_flux(fdm *a, int ipol, field& uvel, double &uflux1, double &uflux2)
{
    if(ipol==1)
    {
...
void flux_face_FOU_2D::v_flux(fdm *a, int ipol, field& vvel, double &vflux1, double &vflux2)
{
    vflux1= 0.0;
    vflux2= 0.0;
}

void flux_face_FOU_2D::w_flux(fdm *a, int ipol, field& wvel, double &wflux1, double &wflux2)
{
