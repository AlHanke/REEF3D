...
void ghostcell::paratracersobj(lexer* p, double** s,double** r, int* psend, int* precv)
{
    if(p->nb1>=0)
    {
...
void ghostcell::paratracersobj2(lexer* p ,tracers_obj* s ,tracers_obj* r)
{
