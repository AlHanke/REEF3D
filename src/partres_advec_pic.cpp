...
void partres::advec_pic(lexer *p, fdm &a, particles_obj2 &PP, size_t n, sediment_fdm &s, turbulence &pturb, 
...
void partres::relative_velocity(lexer *p, fdm &a, particles_obj2::particle _particle, double &du, double &dv, double &dw)
{
        k=p->posc_k(_particle.z);
        double topoDist=p->ccipol4_a(a.topo,_particle.x,_particle.y,_particle.z);
        double u=p->ccipol1c(a.u,_particle.x,_particle.y,_particle.z+velDist*p->DZP[KP]-topoDist);
        double v=p->ccipol2c(a.v,_particle.x,_particle.y,_particle.z+velDist*p->DZP[KP]-topoDist);
        double w=p->ccipol3c(a.w,_particle.x,_particle.y,_particle.z+velDist*p->DZP[KP]-topoDist);
