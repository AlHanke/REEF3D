...
void vtu3D::beginning(lexer *p, std::stringstream &result)
{
    xmlVersion(result);
...
void vtu3D::ending(std::stringstream &result, const int *offset, int &n)
{
    result<<"<Points>\n";
...
void vtu3D::structureWrite(lexer *p, fdm *a, std::vector<char> &buffer, int &m)
{
    float ffn;
    int iin;
    double phase=0.0;
...
void vtu3D::structureWrite(lexer *p, fdm_fnpf *c, std::vector<char> &buffer, int &m)
{
    float ffn;
    int iin;
    double phase=0.0;
...
void vtu3D::structureWrite(lexer *p, fdm_nhf *d, std::vector<char> &buffer, int &m)
{
    float ffn;
    int iin;
    double phase=0.0;
...
void vtu3D::structureWriteEnd(lexer *p, std::vector<char> &buffer, int &m)
{
    int iin;
