...
void mooring_Spring::print(lexer *p)
{
	...
	)
	{
        ...
        if(p->A10==5)
		snprintf(name,sizeof(name),"./REEF3D_NHFLOW_6DOF_Mooring/REEF3D-Mooring-%08i-%06i.vtk",line,num);
        
        if(p->A10==6)
		snprintf(name,sizeof(name),"./REEF3D_CFD_6DOF_Mooring/REEF3D-Mooring-%08i-%06i.vtk",line,num);
