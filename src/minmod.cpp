...
double minmod::iphi(field& b,int n1, int n2, int q1, int q2)
{
...
double minmod::jphi(field& b,int n1, int n2, int q1, int q2)
{
...
double minmod::kphi(field& b,int n1, int n2, int q1, int q2)
{
