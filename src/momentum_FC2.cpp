...
void momentum_FC2::start(lexer *p, fdm *a, ghostcell *pgc, vrans *pvrans, sixdof *p6dof)
{
...
void momentum_FC2::irhs(lexer *p, fdm *a)
{
    n=0;
    ULOOP
    {
...
void momentum_FC2::jrhs(lexer *p, fdm *a)
{
    n=0;
    VLOOP
    {
...
void momentum_FC2::krhs(lexer *p, fdm *a)
{
    n=0;
    WLOOP
    {
