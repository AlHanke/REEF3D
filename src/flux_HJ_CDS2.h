...
public:
    ...
    inline void u_flux(fdm*, int ipol, field& uvel, double &uflux1, double&) override final
    { u_flux_impl(ipol, uvel, uflux1); }

    inline void v_flux(fdm*, int ipol, field& vvel, double &vflux1, double&) override final
    { v_flux_impl(ipol, vvel, vflux1); }

    inline void w_flux(fdm*, int ipol, field& wvel, double &wflux1, double&) override final
    { w_flux_impl(ipol, wvel, wflux1); }

    #if USE_AMREX
    inline void u_flux(fdm*, int ipol, const amrex::Array4<const amrex::Real>& uvel, double &uflux1, double&) override final
    { u_flux_impl(ipol, uvel, uflux1); }

    inline void v_flux(fdm*, int ipol, const amrex::Array4<const amrex::Real>& vvel, double &vflux1, double&) override final
    { v_flux_impl(ipol, vvel, vflux1); }

    inline void w_flux(fdm*, int ipol, const amrex::Array4<const amrex::Real>& wvel, double &wflux1, double&) override final
    { w_flux_impl(ipol, wvel, wflux1); }
    #endif
