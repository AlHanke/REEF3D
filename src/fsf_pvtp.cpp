...
void fsf_vtp::pvtp(lexer* p, fdm* a, ghostcell* pgc)
{
	...
	{
		if(num<10)
		sprintf(name,"REEF3D-CFD-FSF-00000%i.pvtp",num);

		if(num<100&&num>9)
		sprintf(name,"REEF3D-CFD-FSF-0000%i.pvtp",num);

		if(num<1000&&num>99)
		sprintf(name,"REEF3D-CFD-FSF-000%i.pvtp",num);

		if(num<10000&&num>999)
		sprintf(name,"REEF3D-CFD-FSF-00%i.pvtp",num);

		if(num<100000&&num>9999)
		sprintf(name,"REEF3D-CFD-FSF-0%i.pvtp",num);

		if(num>99999)
		sprintf(name,"REEF3D-CFD-FSF-%i.pvtp",num);
	}

	if(p->P14==1)
	{
		if(num<10)
		sprintf(name,"./REEF3D_CFD_FSF/REEF3D-CFD-FSF-00000%i.pvtp",num);

		if(num<100&&num>9)
		sprintf(name,"./REEF3D_CFD_FSF/REEF3D-CFD-FSF-0000%i.pvtp",num);

		if(num<1000&&num>99)
		sprintf(name,"./REEF3D_CFD_FSF/REEF3D-CFD-FSF-000%i.pvtp",num);

		if(num<10000&&num>999)
		sprintf(name,"./REEF3D_CFD_FSF/REEF3D-CFD-FSF-00%i.pvtp",num);

		if(num<100000&&num>9999)
		sprintf(name,"./REEF3D_CFD_FSF/REEF3D-CFD-FSF-0%i.pvtp",num);

		if(num>99999)
		sprintf(name,"./REEF3D_CFD_FSF/REEF3D-CFD-FSF-%i.pvtp",num);
	}
