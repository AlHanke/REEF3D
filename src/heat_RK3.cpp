...
// Step 1
	...
	pdiff->diff_scalar(p,a,pgc,psolv,Tdiff,T,thermdiff,a->eddyv,sigT, 1.0);
...
// Step 2
	...
	pdiff->diff_scalar(p,a,pgc,psolv,Tdiff,ark1,thermdiff,a->eddyv,sigT, 1.0);
...
// Step 3
	...
	pdiff->diff_scalar(p,a,pgc,psolv,Tdiff,ark2,thermdiff,a->eddyv,sigT, 1.0);
