...
class control : public virtual resize_class
{
public:
    control() = default;
    virtual ~control() = default;
protected:
    void read_control(lexer*);
    void ctrlsend();
    void ctrlrecv();
    void ini_default();
    void parse(lexer*);
...
public:
    ...
    int B212;
    double *B212_xc,*B212_zc,*B212_ys,*B212_ye,*B212_r;
    int B213;
    double *B213_xc,*B213_yc,*B213_zs,*B213_ze,*B213_r;
    int B214;
    double *B214_xm1, *B214_ym1, *B214_zm1, *B214_r1, *B214_xm2, *B214_ym2, *B214_zm2, *B214_r2;
    int B215;
    double *B215_xm,*B215_ym,*B215_zm,*B215_r;
    int B217;
    double *B217_xs,*B217_xe,*B217_ys,*B217_ye,*B217_zs,*B217_ze;
    int B218;
    double *B218_xs,*B218_xe,*B218_ys,*B218_ye,*B218_zs,*B218_ze;
    int B219;
    ...
    int P144,P145,P140,P150,P151,P152,P166,P167,P168,P180,P181,P184,P185,P190,P191,P194,P195;
    ...
    int *P144_n;
    double *P145_xs,*P145_xe,*P145_ys,*P145_ye,*P145_transient,*P145_dt;
    int *P145_n;
    double *P167_x;
    ...
    // Sediment Transport
    int S10,S11,S12,S15,S16,S25,S27,S28,S29,S31,S32,S33,S34,S37,S41,S42,S43,S44,S50,S60,S73,S74,S77,S78,S79,S80,S83,S84,S85,S90,S91,S94,S100,S101;
    double S13,S14,S17,S18,S19,S20,S21,S22,S23,S24,S26_a,S26_b,S30,S45,S46,S47,S48,S57,S71,S72,S81,S82,S92,S93,S102;
