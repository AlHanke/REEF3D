...
void momentum_FCC3_PLIC::irhs(lexer *p, fdm *a)
{
    n=0;
    ULOOP
    {
...
void momentum_FCC3_PLIC::jrhs(lexer *p, fdm *a)
{
    n=0;
    VLOOP
    {
...
void momentum_FCC3_PLIC::krhs(lexer *p, fdm *a)
{
    n=0;
    WLOOP
    {
...
void momentum_FCC3_PLIC::face_density(lexer *p, fdm *a, ghostcell *pgc, field1 &rox, field2 &roy, field3 &roz)
{
    ULOOP
