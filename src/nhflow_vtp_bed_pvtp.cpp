...
void nhflow_vtp_bed::pvtu(lexer *p, fdm_nhf *d, ghostcell* pgc, sediment *psed)
{
    ...
    sprintf(name,"./REEF3D_NHFLOW_VTP_BED/REEF3D-NHFLOW-BED-%0*i.pvtp",p->padding_time,num);
...
void nhflow_vtp_bed::piecename(lexer *p, fdm_nhf *d, ghostcell *pgc, int n)
{
    ...
    sprintf(pname,"REEF3D-NHFLOW-BED-%0*i-%0*i.vtp",p->padding_time,num,p->padding_mpi,n+1);
