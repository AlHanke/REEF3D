...
int beam::dec(const int n, double **A, int *ip)
{
...
void beam::sol(const int n, double **A, double *b, int *ip)
{
...
int beam::dech(const int n, double **A, int lb, int *ip)
{
...
void beam::solh(const int n, double **A, int lb, double *b, int *ip)
{
...
int beam::decc(const int n, double **AR, double **AI, int *ip)
{
...
void beam::solc(const int n, double **AR, double **AI, double *br,
    double *bi, int *ip)
{
...
void beam::solhc(const int n, double **AR, double **AI, int lb,
    ...
    if (n != 1) {
        ...
        if (lb != 0) {
            for (int k = 0; k < nm1; k++) {
                ...
                br[k] = tr;
                bi[k] = ti;
                for (int i = kp1; i < min_(n, lb+k+1); i++) {
                    prodr = AR[i][k]*tr - AI[i][k]*ti;
                    prodi = AI[i][k]*tr + AR[i][k]*ti;
                    br[i] += prodr;
                    bi[i] += prodi;
...
int beam::decb(const int n, double **A, int ml, int mu, int *ip)
{
...
void beam::elmhes(const int n, int low, int igh, double **A, int *inter)
{
