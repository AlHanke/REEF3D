...
#ifndef FLUX_FACE_CDS2_VRANS_H_
#define FLUX_FACE_CDS2_VRANS_H_
...
{
public:
    flux_face_CDS2_vrans() = default;
    virtual ~flux_face_CDS2_vrans() = default;

    inline void u_flux(fdm* a, int ipol, field& uvel, double &uflux1, double &uflux2) final
    { u_flux_impl(a, ipol, uvel, uflux1, uflux2); }

    inline void v_flux(fdm* a, int ipol, field& vvel, double &vflux1, double &vflux2) final
    { v_flux_impl(a, ipol, vvel, vflux1, vflux2); }

    inline void w_flux(fdm* a, int ipol, field& wvel, double &wflux1, double &wflux2) final
    { w_flux_impl(a, ipol, wvel, wflux1, wflux2); }

    #if USE_AMREX
    inline void u_flux(fdm* a, int ipol, const amrex::Array4<const amrex::Real>& uvel, double &uflux1, double &uflux2) final
    { u_flux_impl(a, ipol, uvel, uflux1, uflux2); }

    inline void v_flux(fdm* a, int ipol, const amrex::Array4<const amrex::Real>& vvel, double &vflux1, double &vflux2) final
    { v_flux_impl(a, ipol, vvel, vflux1, vflux2); }

    inline void w_flux(fdm* a, int ipol, const amrex::Array4<const amrex::Real>& wvel, double &wflux1, double &wflux2) final
    { w_flux_impl(a, ipol, wvel, wflux1, wflux2); }
    #endif

private:
    template<typename GenericField>
    inline void u_flux_impl(fdm* a, int ipol, GenericField& uvel, double &uflux1, double &uflux2)
    {
        if(ipol==1)
        {
    ...
    template<typename GenericField>
    inline void v_flux_impl(fdm* a, int ipol, GenericField& vvel, double &vflux1, double &vflux2)
    {
        if(ipol==1)
        {
    ...
    template<typename GenericField>
    inline void w_flux_impl(fdm* a, int ipol, GenericField& wvel, double &wflux1, double &wflux2)
    {
        if(ipol==1)
        {
