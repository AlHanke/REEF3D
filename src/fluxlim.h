...
public:
    ...
    inline double iphi(const GernericField& b, int n1, int n2, int q1, int q2) const
    {
    ...
    template<typename GernericField>
    inline double jphi(const GernericField& b, int n1, int n2, int q1, int q2) const
    {
        const int i=increment::i, j=increment::j, k=increment::k;
    ...
    template<typename GernericField>
    inline double kphi(const GernericField& b, int n1, int n2, int q1, int q2) const
    {
        const int i=increment::i, j=increment::j, k=increment::k;
...
protected:
    virtual inline double phi_impl(double vn1, double vn2, double vq1, double vq2, double vcell) const = 0;
};
