...
class geometry_objects : public increment
{
public:
    geometry_objects(lexer*);
    virtual ~geometry_objects();
...
private:
    void box(lexer*, ghostcell*,int&,int&,int,int&,double**,double**,double**,double,double,double,double,double,double);
    void cylinder_y(lexer*, ghostcell*,int&,int&,int,int&,double**,double**,double**,double,double,double,double,double);
