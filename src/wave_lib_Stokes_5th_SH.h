...
class wave_lib_Stokes_5th_SH : public wave_lib_precalc, public wave_lib_parameters, virtual public increment
{
public:
    wave_lib_Stokes_5th_SH(lexer*);
	virtual ~wave_lib_Stokes_5th_SH() = default;
