...
komega_IM1_PLIC::komega_IM1_PLIC(lexer* p, fdm* a, ghostcell *pgc) : komega_func_PLIC(p,a,pgc)
{
	gcval_kin=20;
	gcval_eps=30;
}

komega_IM1_PLIC::~komega_IM1_PLIC()
{
}
...
void komega_IM1_PLIC::timesource(lexer* p, fdm* a, field& fn)
{
    count=0;
    LOOP
    {
...
void komega_IM1_PLIC::clearrhs(lexer* p, fdm* a)
{
    count=0;
    LOOP
    {
