...
void bicgstab_ijk::solve(lexer* p,fdm* a, ghostcell* pgc, vec& rhsvec, int var, int &solveriter, int maxiter, double stop_crit)
 ...
 restart:    
    ...
    i    (fabs(sigma) <= (1.0e-12*(norm_vj*norm_r0)))
